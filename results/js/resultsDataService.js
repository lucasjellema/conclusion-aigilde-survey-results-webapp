...
const surveyDefinitionFile = window.location.href.replace(/\/results\/index\.html$/, '') + '/js/data/conclusionAIGildeSurvey.json';
    ...
    try {
        ...
        try {
            ...
            if (Array.isArray(data)) {
                // If already an array, just return it
                console.log('Using responses as is:', data);
            } else if (typeof data === 'object') {
                // If it's an object, convert to array
                data = Object.values(data);
            } else {
                console.error('Unexpected format for responses:', data);
                return [];
            }
